// Extended from https://github.com/roninoss/rn-primitives/blob/main/packages/popover/src/popover.tsx
...
export const usePopover = (context?: IRootContext): IRootContext => {
...
const Root = React.forwardRef<RootRef, RootProps>(
  ({ asChild, onOpenChange: onOpenChangeProp, context, ...viewProps }, ref) => {
    const {
      nativeID,
      triggerPosition,
      setTriggerPosition,
